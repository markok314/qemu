...
static inline uint32_t ieee_ex_to_rh850(Rh850CPU *cpu, int fexcp)
{
    int ret = 0;
    if (fexcp) {
...
static inline void update_fpcsr(Rh850CPU *cpu)
{
    int tmp = ieee_ex_to_rh850(cpu,
...
uint64_t HELPER(itofd)(CPURh850State *env, uint64_t val)
{
    uint64_t itofd;
...
uint32_t HELPER(itofs)(CPURh850State *env, uint32_t val)
{
    uint32_t itofs;
    Rh850CPU *cpu = rh850_env_get_cpu(env);
...
uint64_t HELPER(ftoid)(CPURh850State *env, uint64_t val)
{
    uint64_t ftoid;
    Rh850CPU *cpu = rh850_env_get_cpu(env);
...
uint32_t HELPER(ftois)(CPURh850State *env, uint32_t val)
{
    uint32_t ftois;
    Rh850CPU *cpu = rh850_env_get_cpu(env);
...
uint64_t helper_float_ ## name ## _d(CPURh850State *env,               \
...
{                                                                         \
    ...
    return result;                                                        \
                                                                          ...
                                                                          \
uint32_t helper_float_ ## name ## _s(CPURh850State *env,               \
...
uint64_t helper_float_madd_d(CPURh850State *env, uint64_t a,
...
uint32_t helper_float_madd_s(CPURh850State *env, uint32_t a,
