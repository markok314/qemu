/*
 * Rh850 system instructions helper routines
 *
...
void HELPER(mtspr)(CPURh850State *env,
    ...
    case TO_SPR(10, 0): /* TTMR */
        {
            if ((env->ttmr & TTMR_M) ^ (rb & TTMR_M)) {
                switch (rb & TTMR_M) {
                case TIMER_NONE:
                    cpu_rh850_count_stop(cpu);
                    break;
                case TIMER_INTR:
                case TIMER_SHOT:
                case TIMER_CONT:
                    cpu_rh850_count_start(cpu);
                    break;
                default:
                    break;
                }
            ...
            cpu_rh850_timer_update(cpu);
        }
        break;

    case TO_SPR(10, 1): /* TTCR */
        cpu_rh850_count_set(cpu, rb);
...
target_ulong HELPER(mfspr)(CPURh850State *env,
                           target_ulong rd, target_ulong ra, uint32_t offset)
{
    ...
    case TO_SPR(10, 1): /* TTCR */
        cpu_rh850_count_update(cpu);
        return cpu_rh850_count_get(cpu);
